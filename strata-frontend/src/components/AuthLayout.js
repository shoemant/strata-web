...
export default function AuthLayout({ children }) {
  ...
  return (
    <div className="fixed inset-0 flex flex-col md:flex-row portrait:flex-col overflow-hidden">
      <div className="h-1/3 md:h-auto md:basis-1/2 xl:basis-3/5 portrait:h-1/3 relative overflow-hidden bg-background">
        <Image
          src="/images/apartment.svg"
          alt="Apartment illustration light"
          fill
          priority
          className={`transition-opacity duration-700 object-center portrait:object-center md:object-contain xl:object-cover xl:object-center ${
      ...
      <div className="flex-1 flex flex-col items-center justify-center bg-background relative px-4 sm:px-6 md:px-8 lg:px-10 portrait:h-2/3 portrait:justify-center">
