    ...
    >
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="space-x-4 text-sm text-primary">
          <button type="button" onClick={() => goToStep("email")} disabled={loadingLogin} className="hover:underline">
            ← Back
          </button>
          <button type="button" onClick={() => goToStep("forgot")} disabled={loadingLogin} className="hover:underline">
            Forgot?
          </button>
        </div>
      </div>
